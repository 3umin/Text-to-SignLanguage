...
os.chdir('C:/Users/ytnal/.jupyter/Github/sign_videos')
vidlist = os.listdir()
...
for vidname in vidlist:
    ...
    bpy.ops.export_anim.bvh(filepath="C:\\\\Users\\\\ytnal\\\\.jupyter\\\\Github\\\\mc\\\\" + vidname[:-4] + '.bvh')


    for i in bpy.data.objects.values():
